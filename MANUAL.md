...
> 內容最後更新：2026-09-16T13:11:00.000Z
...
原文：https://app.notion.com/p/3d6ccd367ae881fe8845e190e429e69d
...
## OakMega 使用手冊 › 訊息測試人員設定（3.0）

原文：https://app.notion.com/p/3-0-3d5ccd367ae881899549c2272b5bbe04
...
原文：https://app.notion.com/p/3d5ccd367ae88173a5bfceaca3708f69
...
原文：https://app.notion.com/p/3d5ccd367ae881698f17fa54f236d5ca
...
原文：https://app.notion.com/p/3d5ccd367ae8810aa9e4e2a2f912d156
...
原文：https://app.notion.com/p/3d5ccd367ae881ac8e6af47f29b48f28
...
## OakMega 使用手冊 › LINE 圖文選單（3.0）

原文：https://app.notion.com/p/LINE-3-0-3d4ccd367ae8817ba735c070338bd3f0
...
> 💡 備註：
>
> - 重置內容後，原本套用此分眾圖文選單的 LINE 好友，會全部套用回預設圖文選單
> - 若該選單有被設定在其他選單的點擊行為，重置後該觸發行為失效，好友點擊後不會有任何反應。待重新設定內容後即會恢復正常觸發
...
## OakMega 使用手冊 › 聊天機器人內容設定（3.0）

原文：https://app.notion.com/p/3-0-3d0ccd367ae880658f98db03a1ddc3cc
...
## OakMega 使用手冊 › 聊天機器人管理頁面（3.0）

原文：https://app.notion.com/p/3-0-3d0ccd367ae8802c9738d2546f7c35a3
...
原文：https://app.notion.com/p/3d0ccd367ae880afb6bee28d85223432
...
## OakMega 使用手冊 › Messenger 選單（2.0）

原文：https://app.notion.com/p/Messenger-2-0-3aeccd367ae88033b561f3ddabbe1abd
...
- **可下載：**允許該成員完整下載所有檔案
- **排除會員個資：**允許下載所有檔案，但下載的檔案會隱藏「真實姓名、信箱、性別、生日、年齡、電話、地址」等欄位
- **不可下載：**所有檔案皆不可下載
...
- 留言機器人名稱：僅用於後台管理管理，不會顯示給 LINE 好友
- 留言機器人時區：判斷時間的依據時區，會影響觸發期限、每週有效時段的判斷基準
...
- 觸發期限
  ...
  - **早於**：設定某個日期之前可觸發
  - **晚於**：設定某個日期之後可觸發
  - **介於**：設定起始與結束日期，僅區間內可觸發
- 限定標籤：具有特定標籤的會員才能觸發回覆
- 排除標籤：沒有特定標籤的會員不會觸發回覆
...
- 觸發機器人貼上標籤：會員觸發此機器人後，系統自動為其貼上指定標籤
- 觸發機器人移除標籤：會員觸發此機器人後，系統自動移除指定標籤
...
## OakMega 使用手冊 › 圖文選單內容設定（2.0）

原文：https://app.notion.com/p/2-0-cbd4abb7cade426588ed810b36a0d852
...
## OakMega 使用手冊 › 圖文選單管理頁面（2.0）

原文：https://app.notion.com/p/2-0-601dfc01a82b47f784c9763077935b9f
...
## OakMega 使用手冊 › 聊天機器人內容設定（2.0）

原文：https://app.notion.com/p/2-0-02d6f78eb46b4deca6314a47e9523450
...
## OakMega 使用手冊 › 聊天機器人管理頁面（2.0）

原文：https://app.notion.com/p/2-0-97ea3d3a6a434bb288fe45a9ce03eaff
